...
function d(){ const fU=null;return new Promise((fV) => { fV((globalThis.document.getElementById("status"),new Promise((fW) => { let fX;let fY;const fZ=(fX={},fX.initDataTypes=["cenc"],fX.videoCapabilities=[(fY={},fY.contentType="video/mp4",fY)],fX);let f0=globalThis.navigator.requestMediaKeySystemAccess("com.widevine.alpha", [fZ]).then((f1) => { c().Set("\u2705 DRM supported: "+String(f1.keySystem));return Promise.resolve(null);});fW(f0);})["catch"]((fW) => { const fX=t(fW);c().Set("\u274c DRM not supported: "+String(fX.message));return Promise.resolve(null);})));});}
