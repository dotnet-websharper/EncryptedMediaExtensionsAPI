...
function Main(){
  ...
  const t=(this_1.h.push(new TextView("status", statusMessage().View)),this_1);
  const b=(t.h.push(EventQ2(t.k, "setupdrm", () => t.i, () => {
    const _3=null;
    StartImmediate(Delay(() => Bind(AsAsync(setupDRM()), () => Return(null))), null);
  })),t);
...
let _c=Lazy((_i) => class $StartupCode_Client {
  ...
  static {
    this.statusMessage=_c_1.Create_1("Waiting for DRM check...");
  }
});
function NewGuid(){
